...
14. rebut(v)(vt,to prove (something) is false by using arguments or evidence)/rebutta(n)/hammer(n)
...
19. stump(to frustrate the progress or efforts of)
...
### 38
1. slate(vt:to designate (someone or something) for a specified purpose or action occurring especially at a fixed time)
