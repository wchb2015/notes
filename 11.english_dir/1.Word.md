...
Take the passwords of the users and before your store them - encrypt them with an encryption key.

Encryption is designed to work in two ways: you can encrypt a user’s passwords to keep it safe but you can also decrypt it to reveal the password again.
